...
$baseURL = "https://tasinfra.blob.core.windows.net/intune-resources/wallpapers"
...
Invoke-WebRequest -Uri "https://tasinfra.blob.core.windows.net/intune-resources/wallpapers/wallpaper-16x9-default.png" -OutFile $dImagePath -TimeoutSec 10 -UseBasicParsing:$true  
Add-StatusRegistryProperty -Application Wallpaper -Operation "Desktop Wallpaper DL" -Status 0
# Download lockscreen wallpaper
Invoke-WebRequest -Uri "https://tasinfra.blob.core.windows.net/intune-resources/wallpapers/wallpaper-16x9-default.png" -OutFile $lImagePath -TimeoutSec 10 -UseBasicParsing:$true
